    ...
    if (desea_comprar) {
        ...
        if (desea_loguearse) {
            ...
            let mail=perfil.mail;
                    ...
                    if (datos_correctos){
                        alert("Los datos ingresados son correctos. A continuación se le asignará un usuario y contraseña.");
                        ...
                        if (user_usuario === usuario && user_password === password){
                            ...
                            if (cambiar_contraseña){
                                ...
                                if(nuevo_password!=""){
                                    if(nuevo_password!=password){
                                        ...
                                        alert("a continuación para adquirir un producto ingrese el código correspondiente al mismo");
                                        ...
                                        document.write("lista de vinos comprados:"+"<br>"+lista_de_productos);
                                        document.write("El total de la comprar es de: "+compra_total+" pesos");
                                    }else{
                            ...
                            let mensaje_sesion="Ingresar correctamente los siguientes datos:\n";
...
function registrarse(){
 let desea_loguearse=confirm("Para proceder a comprar en nuestra página, por favor debes loguearte");
...
function mostrarUsuarioContraseña(){
    ...
    alert("Felicitaciones "+usuario+" se ha podido loguear correctamente. A continuación, inicie sesión");
}
...
function ingresarCodigoVino(){
   let codigo_vino=prompt("Ingrese código del producto a comprar.(cancelar)para terminar");
